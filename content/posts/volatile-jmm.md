---
title: Java内存模型角度解析volatile关键字作用与基础原理
date: 2021-01-03 21:53:38
tags: []
description: 'JMM 就是一种符合内存模型规范的，屏蔽了各种硬件和操作系统的访问差异的，保证了 Java 程序在各种平台下对内存的访问都能保证效果一致的机制及规范。volatile 的一个作用就是保证变量在多线程中是可见的。'
---
