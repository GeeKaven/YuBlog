...
打开 VSCode，点击左下角如图
![vscode-wsl](https://img.tawawa.moe/vscode-wsl.png)

出现如下屏幕选择 `Remote-WSL: New Window。如果要在 WSL 中使用多个发行版，可以选择 using Distro..

![vscode-wsl2](https://img.tawawa.moe/vscode-wsl2.png)
...
![wsl-docker1](https://img.tawawa.moe/wsl-docker1.png)

然后启用集成

![wsl-docker2](https://img.tawawa.moe/wsl-docker2.png)
...
![wsl-nginx](https://img.tawawa.moe/wsl-nginx.png)
