...
const ListItem = (props: JSX.IntrinsicElements['li']) => {
  ...
  if (type === 'ul') {
    marker = (
      <span className='flex items-center pt-1.5 pr-2 text-primary'>
        <HiArrowRight />
      </span>
    )
  }
  ...
  return (
    <li {...rest} className={classNames(className, 'flex items-start mb-2')}>
      {marker}
